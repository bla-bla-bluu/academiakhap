...
body: [
  ...
  "The paper also highlights the importance of documenting Vedic Jāṭ zamindari history within regional historical scholarship. The Dalal family of Kuchesar provides an example of how clan-based authority shaped western Uttar Pradesh over generations, leaving behind both physical monuments and social memory.",

  "## Conclusion",
  "The royal legacy of Kuchesar reveals how Vedic Jāṭ zamindari, Dalal clan history, architecture, and regional political authority intersect across nearly 250 years of continuity. Through Kuchesar Fort, Mud Fort, and Rao Raj Vilas, Harsh Choudhary's research demonstrates that rural heritage is not static. It evolves through inheritance, adaptation, preservation, and changing institutional uses.",
